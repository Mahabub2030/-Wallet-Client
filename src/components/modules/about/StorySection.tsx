      ...
      <section className="py-8 md:py-12 lg:py-16 w-11/12 md:w-11/12 lg:w-11/12 xl:container mx-auto">
        <div className="text-center md:text-left">
          ...
          <h3 className="text-xl font-medium mb-3">
            How Wallet started and where we are now
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Digital-Wallet started with a simple mission: to make digital
            financial transactions simple, fast, and secure. We envisioned a
            platform where users, agents, and businesses can manage money
            effortlessly without worrying about security or delays.
          </p>
