    ...
    <section className="relative overflow-hidden bg-background py-20">
      ...
      <div className="w-11/12 md:w-11/12 lg:w-11/12 xl:container mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            Wallet started with a bold dream — to simplify digital transactions
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center mb-32">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              ...
              hands. Digital-Wallet is about creating opportunities, fostering
              trust, and redefining the way people experience finance.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              At Digital-Wallet, we foster innovation through collaboration. Our
              culture encourages creativity, teamwork, and support, making space
              for breakthrough ideas in digital finance.
            </p>
