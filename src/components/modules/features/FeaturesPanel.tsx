...
const FEATURES = [
  {
    ...
    long: "Real-time transfers between Wallet users and external accounts (agents/banks). Optimized routing ensures near-zero delay and instant confirmation.",
    icon: Zap,
    badge: "Core",
  ...
  },
  {
    ...
    long: "Digital-Wallet ensures 24/7 uptime for all wallet services, allowing users and agents to manage money anytime without interruptions.",
    icon: Clock,
    color: "text-cyan-500",
